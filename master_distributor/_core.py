...
MasterRowsAlias = tuple[str, str, str, int, float]
AllocationRowsAlias = tuple[str, str, str, int, str]
...
def distribute_trade_id(
    master_trade_id: list[MasterRowsAlias],
    allocations_trade_id: list[AllocationRowsAlias],
